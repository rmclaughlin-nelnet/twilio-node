...
export interface DocumentPermissionContext {
  ...
  fetchWithHttpInfo(
    callback?: (
      error: Error | null,
      item?: ApiResponse<DocumentPermissionInstance>,
    ) => any,
  ): Promise<ApiResponse<DocumentPermissionInstance>>;
...
export class DocumentPermissionContextImpl implements DocumentPermissionContext {
  ...
  fetchWithHttpInfo(
    ...
    let operationPromise = operationVersion
      .fetchWithResponseInfo<DocumentPermissionResource>({
        uri: instance._uri,
        method: "get",
        headers,
      })
  ...
  updateWithHttpInfo(
    ...
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion
      .updateWithResponseInfo<DocumentPermissionResource>({
        uri: instance._uri,
        method: "post",
        data,
        headers,
...
export interface DocumentPermissionListInstance {
  ...
  getPageWithHttpInfo(
    ...
    callback?: (
      error: Error | null,
      items: ApiResponse<DocumentPermissionPage>,
    ) => any,
  ): Promise<ApiResponse<DocumentPermissionPage>>;
  /**
  ...
  list(
    callback?: (
      error: Error | null,
      items: DocumentPermissionInstance[],
    ) => any,
  ): Promise<DocumentPermissionInstance[]>;
  list(
  ...
  listWithHttpInfo(
    callback?: (
      error: Error | null,
      items: ApiResponse<DocumentPermissionInstance[]>,
    ) => any,
  ): Promise<ApiResponse<DocumentPermissionInstance[]>>;
  listWithHttpInfo(
    params: DocumentPermissionListInstanceOptions,
