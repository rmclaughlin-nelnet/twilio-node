...
export class TrustProductsEntityAssignmentsContextImpl implements TrustProductsEntityAssignmentsContext {
  ...
  fetchWithHttpInfo(
    ...
    let operationPromise = operationVersion
      .fetchWithResponseInfo<TrustProductsEntityAssignmentsResource>({
        uri: instance._uri,
        method: "get",
        headers,
      })
      .then(
        (response): ApiResponse<TrustProductsEntityAssignmentsInstance> => ({
          ...response,
...
export function TrustProductsEntityAssignmentsListInstance(
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(
    ...
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion
      .createWithResponseInfo<TrustProductsEntityAssignmentsResource>({
        uri: instance._uri,
        method: "post",
        data,
        headers,
