...
import { DeploymentListInstance } from "./environment/deployment.js";
import { LogListInstance } from "./environment/log.js";
import { VariableListInstance } from "./environment/variable.js";
...
export class EnvironmentContextImpl implements EnvironmentContext {
  ...
  fetchWithHttpInfo(
    ...
    let operationPromise = operationVersion
      .fetchWithResponseInfo<EnvironmentResource>({
        uri: instance._uri,
        method: "get",
        headers,
      })
...
export function EnvironmentListInstance(
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(
    ...
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion
      .createWithResponseInfo<EnvironmentResource>({
        uri: instance._uri,
        method: "post",
        data,
        headers,
