...
export class VoiceResponse extends TwiML {
  ...
  dial(attributes?: DialAttributes | string, number?: string): Dial {
  ...
  enqueue(attributes?: EnqueueAttributes, name?: string): Enqueue;
  enqueue(attributes?: EnqueueAttributes | string, name?: string): Enqueue {
    if (typeof attributes === "string") {
      name = attributes;
      attributes = {};
    }
  ...
  play(attributes?: PlayAttributes, url?: string): Play;
  play(attributes?: PlayAttributes | string, url?: string): Play {
    if (typeof attributes === "string") {
      url = attributes;
      attributes = {};
    }
  ...
  queue(attributes: QueueAttributes, name: string): Queue;
  queue(attributes: QueueAttributes | string, name?: string): Queue {
    if (typeof attributes === "string") {
      name = attributes;
      attributes = {};
    }
  ...
  say(attributes: SayAttributes, message: string): Say;
  say(attributes: SayAttributes | string, message?: string): Say {
    if (typeof attributes === "string") {
      message = attributes;
      attributes = {};
    }
  ...
  sms(attributes: SmsAttributes, message: string): Sms;
  sms(attributes: SmsAttributes | string, message?: string): Sms {
    if (typeof attributes === "string") {
      message = attributes;
      attributes = {};
    }
...
export class Application extends TwiML {
  ...
  applicationSid(attributes: object, sid: string): ApplicationSid;
  applicationSid(attributes: object | string, sid?: string): ApplicationSid {
    if (typeof attributes === "string") {
      sid = attributes;
      attributes = {};
    }
   ...
   * @param attributes - TwiML attributes
   */
  parameter(attributes?: ParameterAttributes): Parameter {
    return new Parameter(this.application.ele("Parameter", attributes));
  }
}
...
export class Assistant extends TwiML {
   ...
   * @param attributes - TwiML attributes
   */
  language(attributes?: LanguageAttributes): Language {
    return new Language(this.assistant.ele("Language", attributes));
  }
  /**
   * <Parameter> TwiML Noun
   *
   ...
   */
  parameter(attributes?: ParameterAttributes): Parameter {
    return new Parameter(this.assistant.ele("Parameter", attributes));
  }
}
...
export class Client extends TwiML {
  ...
  identity(attributes: object, clientIdentity: string): Identity;
  identity(attributes: object | string, clientIdentity?: string): Identity {
    if (typeof attributes === "string") {
...
export class Connect extends TwiML {
   ...
   * @param attributes - TwiML attributes
   */
  aiSession(attributes?: AiSessionAttributes): AiSession {
    return new AiSession(this.connect.ele("AiSession", attributes));
  }
  /**
   * <Assistant> TwiML Noun
   *
   * @param attributes - TwiML attributes
   */
  assistant(attributes?: AssistantAttributes): Assistant {
    return new Assistant(this.connect.ele("Assistant", attributes));
  }
  /**
   * <Autopilot> TwiML Noun
   *
  ...
  autopilot(attributes: object | string, name?: string): Autopilot {
    if (typeof attributes === "string") {
      name = attributes;
      attributes = {};
    }
   ...
   * @param attributes - TwiML attributes
   */
  conversation(attributes?: ConversationAttributes): Conversation {
  ...
  room(attributes: RoomAttributes, name: string): Room;
  room(attributes: RoomAttributes | string, name?: string): Room {
    if (typeof attributes === "string") {
      name = attributes;
      attributes = {};
    }
   ...
   * @param attributes - TwiML attributes
   */
  virtualAgent(attributes?: VirtualAgentAttributes): VirtualAgent {
...
export class ConversationRelay extends TwiML {
   ...
   */
  language(attributes?: LanguageAttributes): Language {
    return new Language(this.conversationRelay.ele("Language", attributes));
  }
  /**
   * <Parameter> TwiML Noun
   *
   ...
   */
  parameter(attributes?: ParameterAttributes): Parameter {
    return new Parameter(this.conversationRelay.ele("Parameter", attributes));
  }
}
...
export class Dial extends TwiML {
  ...
  client(attributes?: ClientAttributes, identity?: string): Client;
  client(attributes?: ClientAttributes | string, identity?: string): Client {
    if (typeof attributes === "string") {
      identity = attributes;
      attributes = {};
    }
  ...
  conference(attributes: ConferenceAttributes, name: string): Conference;
  conference(
  ...
  number(attributes: NumberAttributes, phoneNumber: string): Number;
  number(attributes: NumberAttributes | string, phoneNumber?: string): Number {
    if (typeof attributes === "string") {
  ...
  sip(attributes?: SipAttributes, sipUrl?: string): Sip;
  sip(attributes?: SipAttributes | string, sipUrl?: string): Sip {
    if (typeof attributes === "string") {
      sipUrl = attributes;
      attributes = {};
    }
  ...
  whatsApp(attributes: WhatsAppAttributes, phoneNumber: string): WhatsApp;
  whatsApp(
    ...
    return new WhatsApp(this.dial.ele("WhatsApp", attributes, phoneNumber));
  }
}
...
export class Enqueue extends TwiML {
  ...
  task(attributes: TaskAttributes, body: string): Task;
  task(attributes: TaskAttributes | string, body?: string): Task {
    if (typeof attributes === "string") {
      body = attributes;
      attributes = {};
    }
...
export class Hangup extends TwiML {
   ...
   */
  parameter(attributes?: ParameterAttributes): Parameter {
    return new Parameter(this.hangup.ele("Parameter", attributes));
  }
}
...
export class Reject extends TwiML {
   ...
   */
  parameter(attributes?: ParameterAttributes): Parameter {
    return new Parameter(this.reject.ele("Parameter", attributes));
  }
}
...
export class Say extends TwiML {
   ...
   * @param attributes - TwiML attributes
   */
  break(attributes?: SsmlBreakAttributes): SsmlBreak {
  ...
  emphasis(attributes: SsmlEmphasisAttributes, words: string): SsmlEmphasis;
  emphasis(
  ...
  lang(attributes: SsmlLangAttributes, words: string): SsmlLang;
  lang(attributes: SsmlLangAttributes | string, words?: string): SsmlLang {
    if (typeof attributes === "string") {
      words = attributes;
      attributes = {};
    }
  ...
  phoneme(attributes: SsmlPhonemeAttributes, words: string): SsmlPhoneme;
  phoneme(
  ...
  prosody(attributes: SsmlProsodyAttributes, words: string): SsmlProsody;
  prosody(
  ...
  sayAs(attributes: SsmlSayAsAttributes, words: string): SsmlSayAs;
  sayAs(attributes: SsmlSayAsAttributes | string, words?: string): SsmlSayAs {
    if (typeof attributes === "string") {
      words = attributes;
      attributes = {};
    }
  ...
  sub(attributes: SsmlSubAttributes, words: string): SsmlSub;
  sub(attributes: SsmlSubAttributes | string, words?: string): SsmlSub {
    if (typeof attributes === "string") {
      words = attributes;
      attributes = {};
    }
  ...
  w(attributes: SsmlWAttributes, words: string): SsmlW;
  w(attributes: SsmlWAttributes | string, words?: string): SsmlW {
    if (typeof attributes === "string") {
      words = attributes;
      attributes = {};
    }
...
export class Sip extends TwiML {
  ...
  uri(attributes?: SipUriAttributes, sipUrl?: string): SipUri;
  uri(attributes?: SipUriAttributes | string, sipUrl?: string): SipUri {
    if (typeof attributes === "string") {
      sipUrl = attributes;
      attributes = {};
    }
...
export class SsmlEmphasis extends TwiML {
   ...
   */
  break(attributes?: SsmlBreakAttributes): SsmlBreak {
    return new SsmlBreak(this.ssmlEmphasis.ele("break", attributes));
  }
  /**
   * Emphasizing Words in <Say>
   *
  ...
  lang(attributes: SsmlLangAttributes | string, words?: string): SsmlLang {
    ...
    return new SsmlLang(this.ssmlEmphasis.ele("lang", attributes, words));
  }
  /**
   * Using Phonetic Pronunciation in <Say>
   *
  ...
  phoneme(
    ...
    return new SsmlPhoneme(this.ssmlEmphasis.ele("phoneme", attributes, words));
  }
  /**
   * Controling Volume, Speaking Rate, and Pitch in <Say>
   *
  ...
  prosody(
    ...
    return new SsmlProsody(this.ssmlEmphasis.ele("prosody", attributes, words));
  }
  /**
   * Controlling How Special Types of Words Are Spoken in <Say>
   *
  ...
  sayAs(attributes: SsmlSayAsAttributes | string, words?: string): SsmlSayAs {
    ...
    return new SsmlSayAs(this.ssmlEmphasis.ele("say-as", attributes, words));
  }
  /**
   * Pronouncing Acronyms and Abbreviations in <Say>
   *
  ...
  sub(attributes: SsmlSubAttributes | string, words?: string): SsmlSub {
    ...
    return new SsmlSub(this.ssmlEmphasis.ele("sub", attributes, words));
  }
  /**
   * Improving Pronunciation by Specifying Parts of Speech in <Say>
   *
  ...
  w(attributes: SsmlWAttributes | string, words?: string): SsmlW {
    ...
    return new SsmlW(this.ssmlEmphasis.ele("w", attributes, words));
  }
}
...
export class SsmlLang extends TwiML {
   ...
   */
  break(attributes?: SsmlBreakAttributes): SsmlBreak {
    return new SsmlBreak(this.ssmlLang.ele("break", attributes));
  }
  /**
   * Emphasizing Words in <Say>
   *
  ...
  emphasis(
    ...
    return new SsmlEmphasis(this.ssmlLang.ele("emphasis", attributes, words));
  }
  /**
   * Specifying Another Language for Specific Words in <Say>
   *
  ...
  lang(attributes: SsmlLangAttributes | string, words?: string): SsmlLang {
    ...
    return new SsmlLang(this.ssmlLang.ele("lang", attributes, words));
  }
  /**
   * Adding a Pause Between Paragraphs in <Say>
   *
  ...
  phoneme(
    ...
    return new SsmlPhoneme(this.ssmlLang.ele("phoneme", attributes, words));
  }
  /**
   * Controling Volume, Speaking Rate, and Pitch in <Say>
   *
  ...
  prosody(
    ...
    return new SsmlProsody(this.ssmlLang.ele("prosody", attributes, words));
  }
  /**
   * Adding A Pause Between Sentences in <Say>
   *
  ...
  sayAs(attributes: SsmlSayAsAttributes | string, words?: string): SsmlSayAs {
    ...
    return new SsmlSayAs(this.ssmlLang.ele("say-as", attributes, words));
  }
  /**
   * Pronouncing Acronyms and Abbreviations in <Say>
   *
  ...
  sub(attributes: SsmlSubAttributes | string, words?: string): SsmlSub {
    ...
    return new SsmlSub(this.ssmlLang.ele("sub", attributes, words));
  }
  /**
   * Improving Pronunciation by Specifying Parts of Speech in <Say>
   *
...
export class SsmlP extends TwiML {
  ...
  emphasis(
    ...
    return new SsmlEmphasis(this.ssmlP.ele("emphasis", attributes, words));
  }
  /**
   * Specifying Another Language for Specific Words in <Say>
   *
  ...
  lang(attributes: SsmlLangAttributes | string, words?: string): SsmlLang {
    ...
    return new SsmlLang(this.ssmlP.ele("lang", attributes, words));
  }
  /**
   * Using Phonetic Pronunciation in <Say>
   *
  ...
  phoneme(
    ...
    return new SsmlPhoneme(this.ssmlP.ele("phoneme", attributes, words));
  }
  /**
   * Controling Volume, Speaking Rate, and Pitch in <Say>
   *
  ...
  prosody(
    ...
    return new SsmlProsody(this.ssmlP.ele("prosody", attributes, words));
  }
  /**
   * Adding A Pause Between Sentences in <Say>
   *
  ...
  sayAs(attributes: SsmlSayAsAttributes | string, words?: string): SsmlSayAs {
    ...
    return new SsmlSayAs(this.ssmlP.ele("say-as", attributes, words));
  }
  /**
   * Pronouncing Acronyms and Abbreviations in <Say>
   *
  ...
  sub(attributes: SsmlSubAttributes | string, words?: string): SsmlSub {
    ...
    return new SsmlSub(this.ssmlP.ele("sub", attributes, words));
  }
  /**
   * Improving Pronunciation by Specifying Parts of Speech in <Say>
   *
...
export class SsmlProsody extends TwiML {
   ...
   */
  break(attributes?: SsmlBreakAttributes): SsmlBreak {
    return new SsmlBreak(this.ssmlProsody.ele("break", attributes));
  }
  /**
   * Emphasizing Words in <Say>
   *
  ...
  lang(attributes: SsmlLangAttributes | string, words?: string): SsmlLang {
    ...
    return new SsmlLang(this.ssmlProsody.ele("lang", attributes, words));
  }
  /**
   * Adding a Pause Between Paragraphs in <Say>
   *
  ...
  p(attributes: object | string, words?: string): SsmlP {
    ...
    return new SsmlP(this.ssmlProsody.ele("p", attributes, words));
  }
  /**
   * Using Phonetic Pronunciation in <Say>
   *
  ...
  phoneme(
    ...
    return new SsmlPhoneme(this.ssmlProsody.ele("phoneme", attributes, words));
  }
  /**
   * Controling Volume, Speaking Rate, and Pitch in <Say>
   *
  ...
  prosody(
    ...
    return new SsmlProsody(this.ssmlProsody.ele("prosody", attributes, words));
  }
  /**
   * Adding A Pause Between Sentences in <Say>
   *
  ...
  s(attributes: object | string, words?: string): SsmlS {
    ...
    return new SsmlS(this.ssmlProsody.ele("s", attributes, words));
  }
  /**
   * Controlling How Special Types of Words Are Spoken in <Say>
   *
  ...
  sayAs(attributes: SsmlSayAsAttributes | string, words?: string): SsmlSayAs {
    ...
    return new SsmlSayAs(this.ssmlProsody.ele("say-as", attributes, words));
  }
  /**
   * Pronouncing Acronyms and Abbreviations in <Say>
   *
  ...
  sub(attributes: SsmlSubAttributes | string, words?: string): SsmlSub {
    ...
    return new SsmlSub(this.ssmlProsody.ele("sub", attributes, words));
  }
  /**
   * Improving Pronunciation by Specifying Parts of Speech in <Say>
   *
  ...
  w(attributes: SsmlWAttributes | string, words?: string): SsmlW {
    ...
    return new SsmlW(this.ssmlProsody.ele("w", attributes, words));
  }
}
...
export class SsmlS extends TwiML {
  ...
  emphasis(
    ...
    return new SsmlEmphasis(this.ssmlS.ele("emphasis", attributes, words));
  }
  /**
   * Specifying Another Language for Specific Words in <Say>
   *
  ...
  lang(attributes: SsmlLangAttributes | string, words?: string): SsmlLang {
    ...
    return new SsmlLang(this.ssmlS.ele("lang", attributes, words));
  }
  /**
   * Using Phonetic Pronunciation in <Say>
   *
  ...
  phoneme(
    ...
    return new SsmlPhoneme(this.ssmlS.ele("phoneme", attributes, words));
  }
  /**
   * Controling Volume, Speaking Rate, and Pitch in <Say>
   *
  ...
  prosody(
    ...
    return new SsmlProsody(this.ssmlS.ele("prosody", attributes, words));
  }
  /**
   * Controlling How Special Types of Words Are Spoken in <Say>
   *
  ...
  sayAs(attributes: SsmlSayAsAttributes | string, words?: string): SsmlSayAs {
    ...
    return new SsmlSayAs(this.ssmlS.ele("say-as", attributes, words));
  }
  /**
   * Pronouncing Acronyms and Abbreviations in <Say>
   *
  ...
  sub(attributes: SsmlSubAttributes | string, words?: string): SsmlSub {
    ...
    return new SsmlSub(this.ssmlS.ele("sub", attributes, words));
  }
  /**
   * Improving Pronunciation by Specifying Parts of Speech in <Say>
   *
...
export class SsmlW extends TwiML {
  ...
  emphasis(
    ...
    return new SsmlEmphasis(this.ssmlW.ele("emphasis", attributes, words));
  }
  /**
   * Using Phonetic Pronunciation in <Say>
   *
  ...
  phoneme(
    ...
    return new SsmlPhoneme(this.ssmlW.ele("phoneme", attributes, words));
  }
  /**
   * Controling Volume, Speaking Rate, and Pitch in <Say>
   *
  ...
  prosody(
    ...
    return new SsmlProsody(this.ssmlW.ele("prosody", attributes, words));
  }
  /**
   * Controlling How Special Types of Words Are Spoken in <Say>
   *
  ...
  sayAs(attributes: SsmlSayAsAttributes | string, words?: string): SsmlSayAs {
    ...
    return new SsmlSayAs(this.ssmlW.ele("say-as", attributes, words));
  }
  /**
   * Pronouncing Acronyms and Abbreviations in <Say>
   *
  ...
  sub(attributes: SsmlSubAttributes | string, words?: string): SsmlSub {
    ...
    return new SsmlSub(this.ssmlW.ele("sub", attributes, words));
  }
}
...
export class Start extends TwiML {
   ...
   * @param attributes - TwiML attributes
   */
  recording(attributes?: RecordingAttributes): Recording {
    return new Recording(this.start.ele("Recording", attributes));
  }
  /**
   * <Siprec> TwiML Noun
   *
   ...
   * @param attributes - TwiML attributes
   */
  transcription(attributes?: TranscriptionAttributes): Transcription {
    return new Transcription(this.start.ele("Transcription", attributes));
  }
}
...
export class Stop extends TwiML {
   ...
   */
  transcription(attributes?: TranscriptionAttributes): Transcription {
    return new Transcription(this.stop.ele("Transcription", attributes));
  }
}
...
export class Transcription extends TwiML {
  ...
  config(attributes?: ConfigAttributes): Config {
    return new Config(this.transcription.ele("Config", attributes));
  }
  /**
   * <Parameter> TwiML Noun
   *
   ...
   */
  parameter(attributes?: ParameterAttributes): Parameter {
    return new Parameter(this.transcription.ele("Parameter", attributes));
  }
}
